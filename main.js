...
(function() {
  ...
  function formatAPIData(data) {
    var keys = {
        dd_intro: "배달의 기수",
        fmarch_name: "활쏘기 달인",
        fme_at_name: "야생 동물 태그",
        fme_ce_name: "콘도르 알",
        fme_esc_name: "심판의 날",
        fme_kotc_variation_ffa_name: "킹 오브 더 캐슬",
        fme_kotr_name: "철도왕",
        fme_pla_name: "전설의 동물 보호",
        fme_ru_name: "일망타진",
        fme_st_name: "보급로",
        fme_wk_name: "잔해 수색",
        fme_wp_name: "야생동물 사진가",
        fmechal_variation_bow_name: "활쏘기 달인",
        fmechal_variation_fishing_lake_name: "호수 낚시 도전",
        fmechal_variation_fishing_river_name: "강 낚시 도전",
        fmechal_variation_fishing_swamp_name: "늪지 낚시 도전",
        fmechal_variation_flying_bird_name: "새 사냥 컨테스트",
        fmechal_variation_headshot_name: "헤드샷 컨테스트",
        fmechal_variation_herbalist_name: "약초 채집 컨테스트",
        fmechal_variation_horseback_name: "말타고 죽이기 컨테스트",
        fmechal_variation_hunting_name: "야생동물 사냥 컨테스트",
        fmechal_variation_longarm_name: "장총 사살 컨테스트",
        fmechal_variation_sidearm_name: "보조무기 사살 컨테스트",
        gh_name: "폴즈골드",
        hp_intro: "목숨을 건 사수",
    };
